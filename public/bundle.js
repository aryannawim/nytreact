...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router = __webpack_require__(182).Router;
	...
	var Search = React.createClass({
		...
		componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
			...
			if (this.state.term != prevState.term && this.state.startyear != prevState.startyear && this.state.endyear != prevState.endyear) {
				...
				axios.get("https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=b9f91d369ff59547cd47b931d8cbc56b:0:74623931&q=" + term + "&begin_date=" + startyear + "0101&end_date=" + endyear + "1231").then(function (results) {
					// console.log(results)
					// for (var i = 0; i < results.data.response.docs.length; i++) {
					// 	console.log(results.data.response.docs[i].headline.main)
					// }
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'col-lg-12' },
					React.createElement(Query, { callbackParent: this.getSearchTerms })
				),
				React.createElement(
					'div',
					{ className: 'col-lg-12' },
